...
int main(void) {
	 ...
	 /*unsigned int b[]={0,16,32,48,1,17,33,49,2,18,34,50,3,19,35,51,4,20,36,52,5,21,37,53,6,
	 					                         22,38,54,7,23,39,55,8,24,40,56,9,25,41,57,10,26,42,58,11,27,43,59,
	 					                          12,28,44,60,13,29,45,61,14,30,46,62,15,31,47,63};*/
	 unsigned long long int s[]={0x6,0x3,0xa,0x5,0xc,0x8,0x1,0xb,0x0,0xd,0x9,0xe,0xf,0x2,0x7,0x4};
	 unsigned long long int temp=0,sblockop=0;
